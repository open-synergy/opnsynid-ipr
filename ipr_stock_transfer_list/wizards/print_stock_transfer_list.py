...
class PrintStockTransferList(models.TransientModel):
    ...
    warehouse_dest_ids = fields.Many2many(
        string="Destination Warehouse(s)",
        comodel_name="stock.warehouse",
        relation="rel_stock_trans_list_2_warehouse_dest",
        column1="wizard_id",
        column2="warehouse_id",
        required=True,
    )
    ...
    product_ids = fields.Many2many(
        string="Product(s)",
        comodel_name="product.product",
        relation="rel_stock_trans_list_2_product",
        column1="wizard_id",
        column2="product_id",
    )
