...
class PrintStockWasteList(models.TransientModel):
    _name = "stock.print_waste_list"
    _inherit = ["stock.print_list_common"]

    warehouse_ids = fields.Many2many(
        string="Warehouse(s)",
        comodel_name="stock.warehouse",
        relation="rel_stock_waste_list_2_warehouse",
        column1="wizard_id",
    ...
    allowed_product_ids = fields.Many2many(
        ...
        related="company_id.allowed_waste_product_ids",
        store=False,
    )
    ...
    allowed_product_categ_ids = fields.Many2many(
        ...
        related="company_id.allowed_waste_product_categ_ids",
        store=False,
    )
    product_ids = fields.Many2many(
        string="Product(s)",
        comodel_name="product.product",
        relation="rel_stock_waste_list_2_product",
        column1="wizard_id",
        column2="product_id",
    )
    ...
    def action_print_xls(self):
        ...
        return {
            ...
            "report_name": "stock_waste_list_xls",
            "datas": datas,
        }
    ...
    def action_print_ods(self):
        ...
        return {
            "type": "ir.actions.report.xml",
            "report_name": "stock_waste_list_ods",
            "datas": datas,
        }
